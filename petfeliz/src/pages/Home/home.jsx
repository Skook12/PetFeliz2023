      ...
      <main>
        <section className="col-12 d-lg-flex pe-lg-5 pe-sm-0 mt-5 pe-1 bordas-arrendondadas fundo-azul shadow pt-5">
          ...
          >
            ...
            <div>
              <button className="borda-semi-redonda fundo-botao btn px-3 text-white mt-sm-3 mt-md-1 shadow">
                <p>Vamos Começar</p>
              </button>
            </div>
          </div>
          <div className="col-12 col-lg-5 d-flex justify-content-end px-5 px-sm-2 h-sm-100 pt-2 pt-sm-0 mt-sm-auto mt-lg-0">
            <img
              className="dimensao-imagem mt-auto"
              src={ImagemBanner}
              alt="cachorro oculos"
            />
          </div>
